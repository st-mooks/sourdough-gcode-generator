...
##Solution
Several methods to keep the starter warm are available online, but I wanted to attempt to use my 3d printer to keep it warm during the cold winter.
I created a python script to customise the temperature, duration, and wakeup intervals, and then compile it into gcode.
